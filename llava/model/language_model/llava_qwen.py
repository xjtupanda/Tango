...
class LlavaQwenForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        import os
        patch_name = os.environ.get("WRAPPER", None) 

        if patch_name and patch_name in ALGO_MAP:
            BaseModelClass = ALGO_MAP[patch_name]
        else:
            BaseModelClass = Qwen2Model
        ...
        # pandayin: For profiling of generation time and peak memory.
        #################################
